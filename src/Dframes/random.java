...
void opencon(){
    ...
    GMain govt = new GMain();
    CMain camp = new CMain();
    int count = 0;
    /**
    ...
    private void initComponents() {
        ...
        seepwd = new javax.swing.JToggleButton();
        ...
        passlbl.setFont(new java.awt.Font("Verdana", 0, 16)); // NOI18N
        passlbl.setText("Password");

        jLabel5.setFont(new java.awt.Font("Trebuchet MS", 1, 30)); // NOI18N
        jLabel5.setText("Please sign in.");
        ...
        signin.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(signin1, javax.swing.GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        seepwd.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                seepwdItemStateChanged(evt);
            }
        });
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(username, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 210, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(userid, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 210, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(passtf, javax.swing.GroupLayout.PREFERRED_SIZE, 210, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(seepwd, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(seepwd, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(28, 28, 28)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jPanel4, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void signinMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_signinMouseClicked
        ...
        String i = userid.getText();
        CFrame.user = i;
        int i1 = Integer.parseInt(userid.getText());
        String n = username.getText();
        String p = new String(passtf.getPassword());
        String p2 = "";
        try{
            String q = "Select userid from user where userid = " + i + "&& username = '" + n + "'";
            ...
            if(i2==i1){
                ...
                String r = "Select userid from user where userid = " + i + "&& password = '" + p + "'";
            Statement stmt1 = con.createStatement();
            i2 = 0;
            ResultSet rs1 = stmt1.executeQuery(r);
            if(rs1.next()){
                i2 = rs.getInt(1);
                switch(i2){
                    case 1000: 
                    case 1212:
                    case 1225: govt.setVisible(true); break;
                    case 5100:
                    case 5101:
                    case 5102:
                    case 5103: camp.setVisible(true);break;
                }
            this.dispose();
            }
                ...
                JOptionPane.showMessageDialog(this, "User No Avaiable");
                userid.setText("");
                username.setText("");
            }
        }catch(Exception E){
    ...
    private void seepwdItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_seepwdItemStateChanged
        // TODO add your handling code here:
        if(seepwd.isSelected()){
            String p = new String(passtf.getText());
    ...
    }//GEN-LAST:event_seepwdItemStateChanged
    ...
    private javax.swing.JToggleButton seepwd;
